...
class TestWarmupFetcher:
    ...
    def test_partial_warmup_is_retained_when_later_retry_fails(self):
        ...
        assert warmup_fetcher.call_args_list[0].args[-1] == 5
        assert warmup_fetcher.call_args_list[1].args[-1] == 10
    ...
    def test_regular_session_shortfall_across_weekend_and_holiday_is_backfilled(self):
        ...
        assert [call["limit"] for call in calls] == [5, 10]
