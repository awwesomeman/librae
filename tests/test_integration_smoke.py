...
LAYERED_MODULES = [
    "scripts.backtest.run_backtest",
    "scripts.backtest.run_walkforward",
    "scripts.backtest.run_stability",
    ...
    "scripts.strategies.strategy_trendpullback_v1_1_0_d1_l_mxfr1",
]
