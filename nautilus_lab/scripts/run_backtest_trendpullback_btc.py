...
Usage:
    python -m nautilus_lab.scripts.run_backtest_trendpullback_btc [--save-dir DIR]
...
from nautilus_lab.backtest import (
    compute_all,
    metrics_dict_to_backtest_output,
    save_backtest_output,
)
from nautilus_lab.strategies.trendpullback_btc import TrendPullBackParams, backtest
