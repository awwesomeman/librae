...
# Ensure the nautilus_lab sub-project is importable from the project root.
_nautilus_lab_dir = pathlib.Path(__file__).parent / "nautilus_lab"
if str(_nautilus_lab_dir) not in sys.path:
    sys.path.insert(0, str(_nautilus_lab_dir))
