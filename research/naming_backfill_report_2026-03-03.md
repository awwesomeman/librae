...
## 檢查範圍（KEEP / Active）
- scripts/strategy_multifactorscore_v1_1_h1_l_tsi.py（原：multifactorscore_v1_1_h1_l_tsi.py → wrapper）
- scripts/strategy_trendpullback_v1_1_h1_l_btc.py（原：trendpullback_v1_1_h1_l_btc_robust.py → wrapper）
- scripts/strategy_multifactorscore_v1_0_h1_ls_btcf.py（原：btcf_m1_0_m1.py → wrapper）
